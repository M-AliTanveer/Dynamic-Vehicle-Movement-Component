...
#include "DynamicWheel.generated.h"
...
UENUM()
enum class EDynamicAxleType : uint8
{
	Undefined = 0,
	Front,
	Rear
...
UENUM()
enum class EDynamicTorqueCombineMethod : uint8
{
 ...
 * 
 */
UCLASS(BlueprintType, Blueprintable, meta = (DisplayName = "Dynamic Vehicle Wheel"))
class DYNAMICVEHICLEMOVEMENT_API UDynamicWheel : public UObject
{
...
public:
	...
	UPROPERTY(EditAnywhere, Category = Wheel)
	EDynamicTorqueCombineMethod ExternalTorqueCombineMethod;
	...
	UPROPERTY(transient)
	TObjectPtr<class UDynamicVehicleMovementComponent> VehicleComponent;
	...
	UFUNCTION(BlueprintCallable, Category = "Game|Components|WheeledVehicleMovement")
	EDynamicAxleType GetAxleType() { return AxleType; }


	/**
	 * Initialize this wheel instance
	 */
	virtual void Init(class UDynamicVehicleMovementComponent* InVehicleSim, int32 InWheelIndex);
	 ...
	 */
	struct FDynamicWheelSetup& GetWheelSetup();
...
public:
	...
	UDynamicWheel(const FObjectInitializer& ObjectInitializer);
